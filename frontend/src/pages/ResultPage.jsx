              ...
              >
                ...
                <div className="result-display-printable" ref={resultRef} style={{ background: 'white', padding: '20px' }}>
                  <div className="printable-header" style={{ textAlign: 'center', marginBottom: '20px' }}>
                    <div className="header-logos" style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                      <img src="/static/logo.png" alt="" style={{ height: '170px', width: 'auto', objectFit: 'contain' }} />
                    </div>
